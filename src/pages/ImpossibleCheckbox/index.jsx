...
import './impossible-checkbox.css'
...
const SOUNDS = {
  ON: new Audio(new URL('./audio/switch-on.mp3', import.meta.url).href),
  OFF: new Audio(new URL('./audio/switch-off.mp3', import.meta.url).href),
  GROAN: new Audio(new URL('./audio/bear-groan.mp3', import.meta.url).href),
}
SOUNDS.GROAN.playbackRate = 2

const ImpossibleCheckbox = () => {
